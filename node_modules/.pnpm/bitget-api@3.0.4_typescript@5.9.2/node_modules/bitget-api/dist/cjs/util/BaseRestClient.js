...
class BaseRestClient {
    ...
    constructor(restOptions = {}, networkOptions = {}) {
        ...
        this.baseUrl = (0, requestUtils_js_1.getRestBaseUrl)(false, restOptions);
    ...
    async signRequest(data, endpoint, method, signMethod) {
        ...
        console.error(new Date(), (0, websocket_util_js_1.neverGuard)(signMethod, `Unhandled sign method: "${webCryptoAPI_js_1.signMessage}"`));
        return res;
    }
