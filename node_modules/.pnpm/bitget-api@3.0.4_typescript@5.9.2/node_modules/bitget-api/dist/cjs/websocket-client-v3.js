...
exports.WebsocketClientV3 = void 0;
 ...
 */
class WebsocketClientV3 extends BaseWSClient_js_1.BaseWebsocketClient {
    /**
     * Request connection of all dependent (public & private) websockets, instead of waiting for automatic connection by library
     */
    connectAll() {
        return [
            this.connect(websocket_util_js_1.WS_KEY_MAP.v3Private),
            this.connect(websocket_util_js_1.WS_KEY_MAP.v3Public),
        ];
    }
    /**
    ...
    connectWSAPI() {
        ...
        return this.assertIsAuthenticated(websocket_util_js_1.WS_KEY_MAP.v3Private);
    }
    /**
    ...
    subscribe(requests, wsKey) {
        ...
        const normalisedTopicRequests = (0, websocket_util_js_1.getNormalisedTopicRequests)(topicRequests);
    ...
    isWsPong(data) {
        return (0, requestUtils_js_1.isWsPong)(data);
    }
    isPrivateTopicRequest(_request, wsKey) {
        return websocket_util_js_1.WS_AUTH_ON_CONNECT_KEYS.includes(wsKey);
    }
    getPrivateWSKeys() {
        return websocket_util_js_1.WS_AUTH_ON_CONNECT_KEYS;
    }
    isAuthOnConnectWsKey(wsKey) {
        return websocket_util_js_1.WS_AUTH_ON_CONNECT_KEYS.includes(wsKey);
    }
    async getWsUrl(wsKey) {
        return (0, websocket_util_js_1.getWsUrl)(wsKey, this.options, this.logger);
    }
    getMaxTopicsPerSubscribeEvent(wsKey) {
        return (0, websocket_util_js_1.getMaxTopicsPerSubscribeEvent)(wsKey);
    }
    /**
    ...
    async getWsAuthSignature(wsKey) {
        ...
        if (!apiKey || !apiSecret || !apiPass) {
            this.logger.error('Cannot authenticate websocket, either api key, secret or passphrase missing.', { ...websocket_util_js_1.WS_LOGGER_CATEGORY, wsKey });
    ...
    async getWsAuthRequestEvent(wsKey) {
        try {
            ...
            this.logger.error(e, { ...websocket_util_js_1.WS_LOGGER_CATEGORY, wsKey });
            throw e;
        }
    }
    /**
    ...
    resolveEmittableEvents(wsKey, event) {
        ...
        try {
             ...
             */
            if ((0, type_guards_js_1.isWSAPIResponse)(emittableEvent)) {
                // const eg1 = {
                //   event: 'error',
                //   id: '1',
                //   code: '43012',
...
exports.WebsocketClientV3 = WebsocketClientV3;
